...
class Owner(Base):
    ...
    # Preset oficial: avulso na saída off; coleta + foto on.
    default_pode_criar_avulso_saida = Column(Boolean, nullable=False, server_default=text("false"))
...
class Motoboy(Base):
    ...
    # Alinhado ao preset de políticas (avulso saída off por padrão).
    pode_criar_avulso_saida = Column(Boolean, default=False, nullable=False, server_default=text("false"))
