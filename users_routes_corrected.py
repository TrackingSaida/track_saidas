...
class UserFields(BaseModel):
    email: str
    password_hash: str  # MUDANÇA: aceita password_hash como o HTML envia
    username: str
    contato: str
...
def create_user(body: UserFields, db: Session = Depends(get_db)):
    ...
    # MUDANÇA: O HTML já envia a senha em texto plano como 'password_hash', 
    # então precisamos hashear aqui
